...
$$p^∗ = p_0(h/t) + a_0 \frac{h^{k_0}}{t^{k_0}} + a_1 \frac{h^{k_1}}{t^{k_1}} + \cdots$$ La extrapolación de $\text{Richardson}$ consiste en combinar esta identidad con $(1)$, para obtener un nuevo estimador $p_1(h)$ de $p^∗$ , 
...
$$e = (1 + h) 1/h + a0h + . . .$$
donde el número $a_0$ es desconocido. Usar la extrapolación de $\text{Richardson}$ con $t = 2$ para obtener una aproximación del número $e$ de segundo orden. 
**Solución:**
